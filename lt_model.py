...
class LinearTheoryOrographicPrecipitation:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'LinearTheoryOrographicPrecipitation_{}.qm'.format(locale))
        ...
        self.dlg = LinearTheoryOrographicPrecipitationDialog()
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('LinearTheoryOrographicPrecipitation', message)
